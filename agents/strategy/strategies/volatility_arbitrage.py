...
class VolatilityArbitrageStrategy(BaseStrategy):
    name = StrategyName.VOLATILITY_ARBITRAGE.value
    description = "Volatility Arbitrage Strategy (IV vs RV)."
    applicable_market_conditions = [MarketCondition.HIGH_VOLATILITY, MarketCondition.LOW_VOLATILITY]
